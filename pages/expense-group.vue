<template>
  <div>
      ...
      <template #top>
        <v-toolbar elevation="0">
          <v-toolbar-title class="d-flex justify-space-between w-full">
            <div class="font-weight-medium text-capitalize">Expense group</div>
    ...
    <v-dialog v-model="new_dialog" width="580">
      <v-card>
        <v-card-title class="d-flex justify-space-between w-full">
          <div class="text-capitalize font-weight-bold">Create Expense group</div>
        ...
        <v-card-text class="mt-4">
          <v-form ref="new_form">
            <v-text-field
              ...
              filled
              label="Name"
              placeholder="Enter name expense group"
              dense
              color="#7631FF"
            />
            <v-textarea
              ...
              filled
              label="Description"
              placeholder="Enter expense group description"
              dense
              color="#7631FF"
            />
          </v-form>
    ...
    <v-dialog v-model="edit_dialog" width="580">
      <v-card>
        <v-card-title class="d-flex justify-space-between w-full">
          <div class="text-capitalize font-weight-bold">Edit Expense group</div>
    ...
    <v-dialog v-model="delete_dialog" max-width="500">
      <v-card class="pa-4 text-center">
        ...
        <v-card-title class="d-flex justify-center">Delete Expense group</v-card-title>
        <v-card-text>
    ...
    async "options.sortBy"(elem) {
      if (elem[0] !== undefined) {
        if (this.options.sortDesc[0] !== undefined) {
          ...
          await this.sortExpenseGroup({page: this.current_page, size: this.itemPrePage, data: items})
        }
      }
    }
  },

<template>
  <div>
          ...
          <div class="px-4 py-4">
            ...
            <v-form v-model="new_valid" ref="valid" lazy-validation>
              <v-row>
                ...
                <v-col cols="12" lg="3">
                  <div class="label">
                    {{ $t("fabricOrderingBox.index.deliveyTime") }}
                  </div>
    ...
    >
      ...
      <template #item.fabricDesignPhoto="{ item }"> </template>
...
export default {
  data() {
    return {
      ...
      headers: [
        ...
        {
          text: this.$t("planning.listFabric.modelNumber"),
          value: "modelNumber",
          sortable: false,
        },
        {
          text: this.$t("planning.listFabric.fabricSpecification"),
          value: "specification",
          sortable: false,
        },
        {
          text: this.$t("planning.planningChart.densityGrM2"),
          value: "density",
          sortable: false,
        },
        {
          text: this.$t("planning.planningChart.fleece"),
          value: "fleeceEnabled",
          sortable: false,
        },
        {
          text: this.$t("fabricOrderingBox.index.peachEffect"),
          value: "peachEffectEnabled",
          sortable: false,
        },
        {
          text: this.$t("planning.listFabric.color"),
          value: "color",
          sortable: false,
        },
        {
          text: this.$t("planning.listFabric.actualTotalFabric"),
          value: "actualFabricTotal",
          sortable: false,
        },
      ],
      genHeaders: [
        ...
        { text: "Id", value: "id", sortable: false },
        {
          text: this.$t("fabricOrderingBox.index.sipNumber"),
          value: "sipNumber",
          sortable: false,
        },
        {
        ...
        {
          text: this.$t("fabricOrderingBox.index.fabricDesign"),
          value: "fabricDesignPhoto",
          sortable: false,
        },
        {
          text: this.$t("fabricOrderingBox.index.queue"),
          value: "queue",
          sortable: false,
        },
        {
        ...
        {
          text: this.$t("fabricOrderingBox.index.status"),
          value: "status",
          sortable: false,
        },
        {
          text: this.$t("fabricOrderingBox.index.supplier"),
          value: "supplier",
          sortable: false,
        },
        {
          text: this.$t("planning.listFabric.actualTotalFabric"),
          value: "actualTotalFabric",
          sortable: false,
        },
        {
          text: this.$t("fabricOrderingBox.index.actualFabricPrice"),
          value: "actualPrice",
          sortable: false,
        },
        {
          text: this.$t("fabricOrderingBox.index.actualTotalPrice"),
          value: "totalPrice",
          sortable: false,
          width: 200,
        },
        {
          text: this.$t("fabricOrderingBox.index.fabricDeadline"),
          value: "fabricDeadline",
          sortable: false,
        },
        {
          text: this.$t("fabricOrderingBox.index.additionalAccessory"),
          value: "additionalAccessory",
          sortable: false,
        },
  ...
  watch: {
    generatedFabricOrdering(val) {
      ...
      val.forEach((item, id) => {
        let modelNumber =
          item?.modelNumber && item.modelNumber.includes("$")
            ? item.modelNumber.split("$")
            : item.modelNumber;
    ...
    sampleFabricOrdering(val) {
      ...
      val.forEach((item, id) => {
        specialList.push({
          ...item,
          isChecked: JSON.parse(JSON.stringify(item.isOrdered)),
          id: id + 1,
        });
      });
  ...
  methods: {
    ...
    async updateItem() {
      ...
      const { actualPrice, additionalAccessory, fabricOrderId, queue } =
      ...
      if (validate) {
        ...
        await this.updateGeneratedOrders({
          data: formData,
          orderId: this.orderId?.id,
        });

<template >
  <div>
    ...
    <template #item.orderNumber="{item}">
      <td :rowspan="item.accessorys?.length">
        {{ item.orderNumber }}
      </td>
    </template>
  ...
  data(){
    return{
      ...
      headers:[
        ...
        {text: " specification", value: "specification", sortable: false,width:200},
        {text: "Ordered quantity", value: "orderedQuantity", sortable: false},
        {text: "Delivered fact quantity", value: "deliveredFactQuantity", sortable: false},
        {text: "Price per unit", value: "pricePerUnit", sortable: false},
        {text: "Total price", value: "totalPice", sortable: false},
        {text: "Supplier name", value: "supplier", sortable: false},
        {text: "Arrived date", value: "arrivedDate", sortable: false},

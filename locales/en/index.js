export default {
  ...
  forms: {
    ...
    allWarehouseRemaining: "All warehouse remaining",
    shortcomingClassification: "Shortcoming classification",
    dailySorting: "Daily sorting",
    cuttingToOutsourcing: "Cutting to outsourcing",
    sortingToStreams: "Sorting to streams",
  },
  modelBox: {
    table: {
      no: "№",
  ...
  accessoryPlanning: {
    actualOrderQuantity: "Actual order quantity",
    selectTemplate: "Select template",
    totalPrice: "Total price",
    saveAsTemplate: "Save as template",
    coveragePerUnit: "Coverage per unit",
    countedAccessory: "Counted accessory quantity",
    withWastage: "With wastage",
    quantityBySizes: "Quantity by sizes",
    nameNSpecification: "Name and specification",
    actualOrderQuantityOfAcc: "Actual order quantity of acc.",
  },
  readyWarehouse: {
    index: {
      readyGarmentWarehouse: "Ready garment warehouse",
  ...
  shipping: {
    ...
    marking: "Marking",
    enterThePackingListInfo: "Enter the packing list info",
    netWeightPerWork: "Net weight per work/kg",
    selectTheBoxSize: "Select the box size",
    cbmM: "CBM/m3",
    weightOfPerBox: "Weight of per box/kg",
    pcNetWeight: "1 pc net weight (kg)",
    model: "Model/Artikul No.",
    brandName: "Brand name",
  ...
  calculationStatus:{
    ...
    overproduction: "Overproduction %",
    lostResource: "Salary expenses %",
    generalExpenses: "Utilities/Depreciation %",
    extraExpenses: "Period expenses %",
    costPrice: "Cost price",
  ...
  report: {
    ...
    quantityOfModels: "Quantity of models shipping by month",
    createdPrefinances: "Created prefinances",
    placedOrders: "Placed orders",
    prefinanceCreators: "Prefinace creators",
    modelsByGender: "Models by gender",
    orderByCountries: "Order by countries",
    ordersByClients: "Orders by clients",
    ordersByManagers: "Orders by managers",
    monthlySalary: "Monthly salary",
    typical: "Typical",
    daily: "Daily",
    salaryFixed: "Salary fixed report",
    ...
    salaryPerWorkReport: "Salary per work report"
  },
  dailyTasks: {
    worksCompleted: "Number of works completed per employee",
    completedTasks: "Completed tasks",
    deadline: "Deadline",
    laborCost: "Labor cost",
    totalLaborCost: "Total labor cost",
    actualCutQuantity: "Actual cut quantity",
    searchEmployees: "Search employees",
    employeeFullname: "Employee fullname",
    paymentAmount: "Payment amount per operation",
    totalInFact: "Total in fact",
    totalInPlanned: "Total in planned quantity",
    totalInDifference: "Total in difference",
    closeDailyReport: "Close daily report"
  }
};

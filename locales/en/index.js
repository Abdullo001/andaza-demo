export default {
  ...
  process: {
    ...
    dialog: {
      menuName: "Process",
      addMainName: "Create process",
      name: "Name",
      enterMainName: "Enter process name",
      description: "Description",
      descriptionPlacholder: "Enter process  description",
      cancelBtn: "Cancel",
      createBtn: "Save",
      editDialog: "edit process",
      editBtn: "Update",
      deleteDialog: "Delete process",

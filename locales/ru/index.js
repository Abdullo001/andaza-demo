export default {
  ...
  orderBox: {
    ...
    dialog: {
      colorDist: "Ранг/Размер распределение",
      modelPrints: "Модельные отпечатки",
      contract: "Контракт",
    ...
    modelPrint: {
      ...
      creator: "Создатель",
      createdAt: "Создано",
      addPrint: "Добавить печать",
      actions: "Действия",
      addModelPrint: "Добавить модельный отпечаток",
      mainColor: "Основной цвет",
      colorQuantity: "Количество цветов",
      printType: "Тип печати",
  ...
  planning: {
    ...
    order: {
      ...
      quantityCutting: "Количество резки",
      remainderCutting: "Остаток резки",
  ...
  fabricOrderingBox: {
    index: {
      ...
      additionalAccessory: "Дополнительный аксессуар",
      noData: "Нет доступных данных",
      return: "Вернуться",
    ...
    id: {
      ...
      plannedAccessoryExpense:
        "Планируемые расходы на аксессуары за 1 комплект",
      expenseAmount: "0.00",
      headOfProductionDepartment: "Руководитель производственного отдела",
      enterHeadOfProductionDepartment:
        "Введите руководителя производственного отдела",
      ...
      currency: "Валюта",
      save: "Сохранить",
      accessoryPlanningChart: "Таблица планирования аксессуаров",
      accessoryPlannedOrder: "Планируемый заказ аксессуаров",
    },
    addAccessoryBox: {
      addAccessory: "Добавить аксессуар",
      name: "Имя",
      selectName: "Выбрать имя",
      pricePerUnit: "Цена за единицу",
      measurementUnit: "Единица измерения",
      ...
      description: "Описание",
      enterCanvasType: "Введите тип холста",
      ...
      accessoryPhoto: "Фото аксессуара",
      quantity: "Количество",
      wastage: "Потери",
      productionQuantity: "Количество производства",
      totalAccessory: "Всего аксессуаров",
      description: "Описание",
      actions: "Действия",
    },
    plannedAccessoryOrderBox: {
      ...
      accessNameSpecification: "Имя и спецификация доступа",
      status: "Статус",
  ...
  fabricWarehouse: {
    ...
    givenToCutting: "Передано в резку",
  ...
  accessoryWarehouse: {
    ...
    accessoryName: "Название аксессуара",
    accessoryStock: "Сток аксессуаров",
    modelNumber: "Модель №",
    supplierName: "Имя поставщика",
    search: "Поиск",
    addAccessoryStock: " Добавить Сток аксессуаров",
    orderNumber: "Заказ №",
    accessorySpecification: "Спецификация аксессуара",
    accessoryPhoto: "Фото аксессуара",
    remainingQuantity: "Оставшееся количество",
    pricePerUnit: "Цена за единицу",
    totalPrice: "Общая цена",
  ...
  waybillId: {
    waybillNo: "Накладная №",
    branchName: "Имя филиала/субподрядчика",
 ...
 calculationStatus:{
  ...
  warehouseId:{
   ...
   want:"Вы хотите отдать текущий аксессуар на склад аксессуаров?",
   ...
   deleteStock:"Удалить строку сток аксессуаров",
   wantToDelete:"Вы уверены, что хотите удалить эту строку запасов аксессуаров?",
  },
};

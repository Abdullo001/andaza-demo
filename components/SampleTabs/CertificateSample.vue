    ...
    <v-dialog v-model="new_dialog" max-width="572">
      <v-card>
        <v-card-title class="w-full d-flex justify-space-between">
          <div>CERTIFICATE SAMPLE info</div>
        ...
        <v-card-text>
          <v-form lazy-validation v-model="new_validate" ref="new_form">
            <v-row class="mb-4">
              ...
              <v-col cols="12" lg="6">
                <div class="label">CERTIFICATE SAMPLE Sent date</div>
...
export default {
  name: "CertificateSampleComponent",
  data() {
    return {
      partnerName:"",
      delete_dialog:false,
      ...
      headers: [
        ...
        {
          text: "CERTIFICATE SAMPLE sent date",
          align: "center",
          sortable: false,
          value: "sendDate",
        },
  ...
  methods: {
    ...
    async saveFqs(){
      ...
      data.purpose="CERTIFICATE_SAMPLE"

<template>
  <v-card flat class="rounded-lg">
    <v-data-table item-key="calculation" :headers="headers" :items="[...allClassificationList,...allSubcontractClassificationList]">
      <template #top>
        <v-row class="pa-4">
          <v-col cols="6">
            <div class="title">All classification of shortcomings</div>
          </v-col>
          <!-- <v-col cols="6">
            <div>
              <v-select
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      allClassificationList:"commonCalculationsShortcomings/allClassificationList",
      allSubcontractClassificationList:"commonCalculationsShortcomings/allSubcontractClassificationList",
    }),
  },

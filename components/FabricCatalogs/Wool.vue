<template>
  <div>
      ...
      <template #top>
        <v-toolbar elevation="0" class="rounded-lg">
          <v-toolbar-title class="d-flex justify-space-between w-full">
            <div class="font-weight-medium text-capitalize">Wool</div>
    ...
    <v-dialog v-model="new_dialog" width="580">
      <v-card>
        <v-card-title class="d-flex justify-space-between w-full">
          <div class="text-capitalize font-weight-bold">Create Wool</div>
    ...
    <v-dialog v-model="edit_dialog" width="580">
      <v-card>
        <v-card-title class="d-flex justify-space-between w-full">
          <div class="text-capitalize font-weight-bold">Edit Wool</div>
    ...
    <v-dialog v-model="delete_dialog" max-width="500">
      <v-card class="pa-4 text-center">
        ...
        <v-card-title class="d-flex justify-center">Delete Wool</v-card-title>
        <v-card-text>
          Are you sure you want to Delete this Wool?
        </v-card-text>
